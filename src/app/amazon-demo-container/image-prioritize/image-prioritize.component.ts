...
@Component({
  selector: 'app-image-prioritize',
  templateUrl: './image-prioritize.component.html',
  styleUrls: ['./image-prioritize.component.css']
})
export class ImagePrioritizeComponent implements OnInit {
  slides:Array<any>=
  [
  ...
  constructor(private titleService: Title) { 
    titleService.setTitle("Attryb Tech: Image Prioritize");
  }
