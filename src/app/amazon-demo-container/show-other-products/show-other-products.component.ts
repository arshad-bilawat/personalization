...
@Component({
  selector: 'app-show-other-products',
  templateUrl: './show-other-products.component.html',
  styleUrls: ['./show-other-products.component.css']
})
export class ShowOtherProductsComponent implements OnInit {
  slides:Array<any>=
  [
  ...
  constructor(private titleService: Title) { 
    titleService.setTitle("Attryb Tech: Show Others");
  }
